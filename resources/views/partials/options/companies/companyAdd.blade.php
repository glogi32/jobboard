      ...
      <form role="form" method="POST" action="{{route("companies.store")}}" enctype="multipart/form-data">
        ...
        <div class="row form-group mb-4">
          <div class="col-md-12 mb-1 mb-md-0">
            ...
            <input type="text" id="tbName" name="name" class="form-control @if($errors->has("name")) is-invalid @endif" value="{{old("name")}}">
        ...
        <div class="row form-group mb-1 ">
            <div class="col-md-6 mb-1 mb-md-0">
                ...
                <input type="text" id="tbWebsite" name="website" class="form-control @if($errors->has("website")) is-invalid @endif"  placeholder="http://..." value="{{old("website")}}">
                <div class="invalid-feedback">
        ...
        <div class="row form-group my-4">
            <div class="col-md-12 mb-1 mb-md-0">
                <label class="text-black" for="about-us">About us</label>
                <textarea rows="20" id="summernote" name="about-us" class="form-control @if($errors->has("about-us")) is-invalid @endif" placeholder="Tell us something about you...">{{old("about-us")}}</textarea> 
                <div class="invalid-feedback">
        ...
        <div class="row form-group md-2 pl-4">
          <div class="col-md-6  mb-3 mb-md-0 ">
            <label class="text-black" for="tbLogo">Logo</label><br/>
          ...
          <div class="col-md-6  mb-3 mb-md-0">
            <label class="text-black" for="tbImage">Insert description images:</label><br/>
          ...
          <div class="form-group row">
              <div class="col-lg-9 ml-auto text-right">
                  ...
                  <input type="submit" class="btn btn-primary" value="Insert company" />
              </div>
          </div>
      </form>
  </div>
